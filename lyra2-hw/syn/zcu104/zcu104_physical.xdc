# --------------------------------------------------------------------------------
# This file contains the ZCU104 evaluation board physical constraints (Rev1.0).
# --------------------------------------------------------------------------------
...
# Clocks 
# ---------------------------
set_property PACKAGE_PIN E23            [get_ports "SYSCLK_N"] ;# (125MHz) Bank  28 VCCO - VCC1V8   - IO_L13N_T2L_N1_GC_QBC_28
set_property IOSTANDARD  LVDS           [get_ports "SYSCLK_N"] ;# (125MHz) Bank  28 VCCO - VCC1V8   - IO_L13N_T2L_N1_GC_QBC_28
set_property PACKAGE_PIN F23            [get_ports "SYSCLK_P"] ;# (125MHz) Bank  28 VCCO - VCC1V8   - IO_L13P_T2L_N0_GC_QBC_28
set_property IOSTANDARD  LVDS           [get_ports "SYSCLK_P"] ;# (125MHz) Bank  28 VCCO - VCC1V8   - IO_L13P_T2L_N0_GC_QBC_28
...
# 4 x LEDs
set_property PACKAGE_PIN D5       [get_ports "GPIO_LED[0]"] ;# Bank  88 VCCO - VCC3V3   - IO_L11N_AD9N_88
set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_LED[0]"] ;# Bank  88 VCCO - VCC3V3   - IO_L11N_AD9N_88
set_property PACKAGE_PIN D6       [get_ports "GPIO_LED[1]"] ;# Bank  88 VCCO - VCC3V3   - IO_L11P_AD9P_88
set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_LED[1]"] ;# Bank  88 VCCO - VCC3V3   - IO_L11P_AD9P_88
set_property PACKAGE_PIN A5       [get_ports "GPIO_LED[2]"] ;# Bank  88 VCCO - VCC3V3   - IO_L10N_AD10N_88
set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_LED[2]"] ;# Bank  88 VCCO - VCC3V3   - IO_L10N_AD10N_88
set_property PACKAGE_PIN B5       [get_ports "GPIO_LED[3]"] ;# Bank  88 VCCO - VCC3V3   - IO_L10P_AD10P_88
set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_LED[3]"] ;# Bank  88 VCCO - VCC3V3   - IO_L10P_AD10P_88

# 4 x DIP Switches
#set_property PACKAGE_PIN F4       [get_ports "GPIO_DIP_SW[3]"] ;# Bank  88 VCCO - VCC3V3   - IO_L9N_AD11N_88
#set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_DIP_SW[3]"] ;# Bank  88 VCCO - VCC3V3   - IO_L9N_AD11N_88
#set_property PACKAGE_PIN F5       [get_ports "GPIO_DIP_SW[2]"] ;# Bank  88 VCCO - VCC3V3   - IO_L9P_AD11P_88
#set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_DIP_SW[2]"] ;# Bank  88 VCCO - VCC3V3   - IO_L9P_AD11P_88
#set_property PACKAGE_PIN D4       [get_ports "GPIO_DIP_SW[1]"] ;# Bank  88 VCCO - VCC3V3   - IO_L8N_HDGC_88
#set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_DIP_SW[1]"] ;# Bank  88 VCCO - VCC3V3   - IO_L8N_HDGC_88
#set_property PACKAGE_PIN E4       [get_ports "GPIO_DIP_SW[0]"] ;# Bank  88 VCCO - VCC3V3   - IO_L8P_HDGC_88
#set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_DIP_SW[0]"] ;# Bank  88 VCCO - VCC3V3   - IO_L8P_HDGC_88

# 4 x Push-buttons 
#set_property PACKAGE_PIN B4       [get_ports "GPIO_PB_SW[0]"] ;# Bank  88 VCCO - VCC3V3   - IO_L7N_HDGC_88
#set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_PB_SW[0]"] ;# Bank  88 VCCO - VCC3V3   - IO_L7N_HDGC_88
#set_property PACKAGE_PIN C4       [get_ports "GPIO_PB_SW[1]"] ;# Bank  88 VCCO - VCC3V3   - IO_L7P_HDGC_88
#set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_PB_SW[1]"] ;# Bank  88 VCCO - VCC3V3   - IO_L7P_HDGC_88
#set_property PACKAGE_PIN B3       [get_ports "GPIO_PB_SW[2]"] ;# Bank  88 VCCO - VCC3V3   - IO_L6N_HDGC_88
#set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_PB_SW[2]"] ;# Bank  88 VCCO - VCC3V3   - IO_L6N_HDGC_88
#set_property PACKAGE_PIN C3       [get_ports "GPIO_PB_SW[3]"] ;# Bank  88 VCCO - VCC3V3   - IO_L6P_HDGC_88
#set_property IOSTANDARD  LVCMOS33 [get_ports "GPIO_PB_SW[3]"] ;# Bank  88 VCCO - VCC3V3   - IO_L6P_HDGC_88
...
# ---------------------------
### PMOD 0
#set_property PACKAGE_PIN G8       [get_ports "PMOD0[0]"] ;# Bank  87 VCCO - VCC3V3   - IO_L12N_AD0N_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD0[0]"] ;# Bank  87 VCCO - VCC3V3   - IO_L12N_AD0N_87
#set_property PACKAGE_PIN H8       [get_ports "PMOD0[1]"] ;# Bank  87 VCCO - VCC3V3   - IO_L12P_AD0P_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD0[1]"] ;# Bank  87 VCCO - VCC3V3   - IO_L12P_AD0P_87
#set_property PACKAGE_PIN G7       [get_ports "PMOD0[2]"] ;# Bank  87 VCCO - VCC3V3   - IO_L11N_AD1N_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD0[2]"] ;# Bank  87 VCCO - VCC3V3   - IO_L11N_AD1N_87
#set_property PACKAGE_PIN H7       [get_ports "PMOD0[3]"] ;# Bank  87 VCCO - VCC3V3   - IO_L11P_AD1P_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD0[3]"] ;# Bank  87 VCCO - VCC3V3   - IO_L11P_AD1P_87
#set_property PACKAGE_PIN G6       [get_ports "PMOD0[4]"] ;# Bank  87 VCCO - VCC3V3   - IO_L10N_AD2N_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD0[4]"] ;# Bank  87 VCCO - VCC3V3   - IO_L10N_AD2N_87
#set_property PACKAGE_PIN H6       [get_ports "PMOD0[5]"] ;# Bank  87 VCCO - VCC3V3   - IO_L10P_AD2P_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD0[5]"] ;# Bank  87 VCCO - VCC3V3   - IO_L10P_AD2P_87
#set_property PACKAGE_PIN J6       [get_ports "PMOD0[6]"] ;# Bank  87 VCCO - VCC3V3   - IO_L9N_AD3N_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD0[6]"] ;# Bank  87 VCCO - VCC3V3   - IO_L9N_AD3N_87
#set_property PACKAGE_PIN J7       [get_ports "PMOD0[7]"] ;# Bank  87 VCCO - VCC3V3   - IO_L9P_AD3P_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD0[7]"] ;# Bank  87 VCCO - VCC3V3   - IO_L9P_AD3P_87
### PMOD 1
#set_property PACKAGE_PIN J9       [get_ports "PMOD1[0]"] ;# Bank  87 VCCO - VCC3V3   - IO_L8N_HDGC_AD4N_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD1[0]"] ;# Bank  87 VCCO - VCC3V3   - IO_L8N_HDGC_AD4N_87
#set_property PACKAGE_PIN K9       [get_ports "PMOD1[1]"] ;# Bank  87 VCCO - VCC3V3   - IO_L8P_HDGC_AD4P_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD1[1]"] ;# Bank  87 VCCO - VCC3V3   - IO_L8P_HDGC_AD4P_87
#set_property PACKAGE_PIN K8       [get_ports "PMOD1[2]"] ;# Bank  87 VCCO - VCC3V3   - IO_L7N_HDGC_AD5N_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD1[2]"] ;# Bank  87 VCCO - VCC3V3   - IO_L7N_HDGC_AD5N_87
#set_property PACKAGE_PIN L8       [get_ports "PMOD1[3]"] ;# Bank  87 VCCO - VCC3V3   - IO_L7P_HDGC_AD5P_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD1[3]"] ;# Bank  87 VCCO - VCC3V3   - IO_L7P_HDGC_AD5P_87
#set_property PACKAGE_PIN L10      [get_ports "PMOD1[4]"] ;# Bank  87 VCCO - VCC3V3   - IO_L6N_HDGC_AD6N_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD1[4]"] ;# Bank  87 VCCO - VCC3V3   - IO_L6N_HDGC_AD6N_87
#set_property PACKAGE_PIN M10      [get_ports "PMOD1[5]"] ;# Bank  87 VCCO - VCC3V3   - IO_L6P_HDGC_AD6P_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD1[5]"] ;# Bank  87 VCCO - VCC3V3   - IO_L6P_HDGC_AD6P_87
#set_property PACKAGE_PIN M8       [get_ports "PMOD1[6]"] ;# Bank  87 VCCO - VCC3V3   - IO_L5N_HDGC_AD7N_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD1[6]"] ;# Bank  87 VCCO - VCC3V3   - IO_L5N_HDGC_AD7N_87
#set_property PACKAGE_PIN M9       [get_ports "PMOD1[7]"] ;# Bank  87 VCCO - VCC3V3   - IO_L5P_HDGC_AD7P_87
#set_property IOSTANDARD  LVCMOS33 [get_ports "PMOD1[7]"] ;# Bank  87 VCCO - VCC3V3   - IO_L5P_HDGC_AD7P_87
...
# --------------------------------------
# Unused Pins - Unused Transceivers
# --------------------------------------
...
# --------------------------------------
# Unused Pins - Programmable Logic (PL)
# --------------------------------------
...
# --------------------------------------
# Unused Nets - Processing System (PS)
# --------------------------------------
